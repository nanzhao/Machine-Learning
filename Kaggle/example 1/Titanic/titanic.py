...
print(data_train.info())     # dtypes, 数量多少个
print(data_train.describe()) # 各列的统计值
...
# 数据缺失的不是很多，还可以利用一下，这里离散的数据，直接转换为有记录无记录两种
...
# 对cross validation数据进行预测，cross validation这里用来分析哪些是bad case的情况
